...
function Hero() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center  bg-gradient-to-r from-sky-500 to-sky-300 overflow-hidden h-[666px]">
     ...
     {/* Top Corners */}
      ...
      <img src="./images/worldwide.png" alt="Worldwide" className="absolute top-1/4 right-1/3 w-14 h-14 opacity-25" />
